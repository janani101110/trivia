        ...
        <tbody>
          <tr>
            <Link to="/micro?category=Popular Microcontroller Families" className={getLinkClassName("Popular Microcontroller Families")}>
              <td>Popular Microcontroller Families</td>
            </Link>
          </tr>
          <tr>
            <Link to="/micro?category=Development Environments" className={getLinkClassName("Development Environments")}>
              <td>Development Environments</td>
            </Link>
          </tr>
          <tr>
            <Link to="/micro?category=Programming Microcontrollers" className={getLinkClassName("Programming Microcontrollers")}>
              <td>Programming Microcontrollers</td>
            </Link>
          </tr>
          <tr>
            <Link to="/micro?category=Power Management for Microcontrollers" className={getLinkClassName("Power Management for Microcontrollers")}>
              <td>Power Management for Microcontrollers</td>
            </Link>
          </tr>
          <tr>
            <Link to="/micro?category=Interfaces and Peripherals" className={getLinkClassName("Interfaces and Peripherals")}>
              <td>Interfaces and Peripherals</td>
            </Link>
          </tr>
        </tbody>
      </table>

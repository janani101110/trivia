...
const QuestionCard = ({ question }) => {
  ...
  return (
    <div onClick={handleCardClick} className='cardBox' style={{ border: '1px solid', marginBottom: '15px', padding: '20px', borderRadius: '25px', boxShadow: '2px 2px 2px',marginRight:'25px' }}>
